...
var TitleCaseCtx = React.createContext(DEFAULT_OPTIONS);
function useTitleCaseCtx() {
  return React.useContext(TitleCaseCtx);
}
var TitleCaseProvider = function TitleCaseProvider(props) {
  ...
  return React.createElement(TitleCaseCtx.Provider, {
    value: value
  }, children);
};
var TitleCase = function TitleCase(props) {
  ...
  return React.createElement(TitleCaseCtx.Consumer, null, function render(value) {
...
function useTitleCase(options) {
  ...
  return React.useCallback(titleCase, [overrides]);
}

exports.TitleCase = TitleCase;
exports.TitleCaseProvider = TitleCaseProvider;
exports.builtInOverrides = builtInOverrides;
exports.useTitleCase = useTitleCase;
